    ...
    function setUp() public virtual override {
        ...
        aOFT = MockNestShareOFT(
            _deployContractAndProxy(
                ...
                abi.encodeWithSelector(NestShareOFT.initialize.selector, "aOFT", "aOFT", address(this))
            )
        );
        ...
        bOFT = MockNestShareOFT(
            _deployContractAndProxy(
                ...
                abi.encodeWithSelector(NestShareOFT.initialize.selector, "bOFT", "bOFT", address(this))
            )
        );
