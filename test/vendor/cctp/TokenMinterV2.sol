...
contract TokenMinterV2 is ITokenMinterV2, TokenMinter {
    ...
    function mint(
        ...
        uint256 amountOne,
        uint256 amountTwo
    ) external override whenNotPaused onlyLocalTokenMessenger returns (address) {
        ...
        require(_token.mint(recipientOne, amountOne), "First mint operation failed");

        require(_token.mint(recipientTwo, amountTwo), "Second mint operation failed");
