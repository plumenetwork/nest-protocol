 ...
 */
contract BaseMessageTransmitter is Initializable, Pausable, Rescuable, AttestableV2 {
    // ============ Events ============
    /**
     ...
     */
    constructor(uint32 _localDomain, uint32 _version) Ownable(msg.sender) {
     ...
     */
    function setMaxMessageBodySize(uint256 newMaxMessageBodySize) external onlyOwner {
