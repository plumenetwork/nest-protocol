...
abstract contract DeployNestVaultOFT is DeployNestProtocolOFT {
        ...
        returns (address implementation, address proxy)
    {
        ...
        implementation = address(new NestVaultOFT(payable(_nestVaultConfig.boringVault), broadcastConfig.endpoint));
        ...
        require(NestVaultOFT(proxy).owner() == vm.addr(oftDeployerPK), "NestVaultOFT owner incorrect");
    }
