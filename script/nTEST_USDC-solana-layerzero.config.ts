...
const plumeContract: OmniPointHardhat = {
    ...
    contractName: 'nTESTOFT', // Note: change this to your production contract name
    address: "0x802E1f92A6890430bCF350Ad553C936fA425266c"
}

// Solana contract: use OmniPoint (not OmniPointHardhat) to avoid EVM validation
...
export default async function () {
    ...
    const connections = await generateConnectionsConfig([
        [
            plumeContract, // Chain A contract
    ...
    return {
        contracts: [{ contract: plumeContract }, { contract: solanaContract }],
        connections,
    }
}
