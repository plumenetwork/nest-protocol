            ...
            [
                {
                    ...
                    minAmountLD: 0,
                    extraOptions: '0x',
                    composeMsg: utils.defaultAbiCoder.encode(['uint8'], [1]),
                    oftCmd: '0x',
                },
                0,
            ],
...
task('lz:oft:nest:request-redeem', 'Request Redeem nest tokens cross‐chain from Solana to any supported chain')
